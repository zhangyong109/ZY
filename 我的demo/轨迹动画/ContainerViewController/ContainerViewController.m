...
- (void)loadView
{
	...
	frame = CGRectInset(view.bounds, 10, 100);
...
- (void)transitionFromViewController:(UIViewController *)fromViewController toViewController:(UIViewController *)toViewController direction:(UISwipeGestureRecognizerDirection) direction
{
...
- (void)swipeLeft:(UISwipeGestureRecognizer *)gesture
{
	if (gesture.state == UIGestureRecognizerStateRecognized)
	{
		...
		[self transitionFromViewController:_selectedViewController toViewController:newSubViewController direction:UISwipeGestureRecognizerDirectionLeft];
...
- (void)swipeRight:(UISwipeGestureRecognizer *)gesture
{
	if (gesture.state == UIGestureRecognizerStateRecognized)
	{
		...
		[self transitionFromViewController:_selectedViewController toViewController:newSubViewController direction:UISwipeGestureRecognizerDirectionRight];
		_selectedViewController = newSubViewController;
	}
}
