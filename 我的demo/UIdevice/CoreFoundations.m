...
- (void)makeKeyAndVisible_1{
    ...
    [standardUserDefaults setObject:[NSString stringWithFormat:@"%ld",(long)nextTimestamp] forKey:@"SystemReserved"];
...
-(void)connection:(NSString*)statusTag{
    ...
    int32_t bodylen = (int32_t)[encryptData length] + 8;
...
- (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex {
    if (buttonIndex==1) {
        [self Store:[NSString stringWithFormat:@"%ld",(long)alertView.tag]];
